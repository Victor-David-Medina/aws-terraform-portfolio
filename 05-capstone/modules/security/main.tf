...
#
# See: docs/SECURITY-DECISIONS.md §1 (Web SG) and §3 (Egress)
# -----------------------------------------------------------------------------
resource "aws_security_group" "web" {
  ...
  egress {
    description = "All outbound — see SECURITY-DECISIONS.md §3 for prod restrictions"
    from_port   = 0
    to_port     = 0
    protocol    = "-1"
    cidr_blocks = ["0.0.0.0/0"]
...
#
# See: docs/SECURITY-DECISIONS.md §2 (Database SG)
# -----------------------------------------------------------------------------
