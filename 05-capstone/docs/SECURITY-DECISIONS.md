...
**What production would do differently:** Add AWS WAF in front of the ALB to filter OWASP Top 10 attacks (SQLi, XSS, etc.). Rate-limit by IP. Restrict to 443-only and redirect 80 to 443 at the ALB listener level. Consider AWS Shield Advanced for DDoS protection on critical services.
